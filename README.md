...
### Quickstart
If you want to run the Movies and Shows API, make sure you have [Nodejs] (https://nodejs.org/en/) installed and are able to run the following commands in the repository directory:
```
$ npm install
$ node server.js
```
